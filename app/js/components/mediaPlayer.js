...
var icon              = remote.nativeImage.createFromPath(app.getAppPath() + '/nimbus.png');
...
var MediaPlayer = React.createClass({
  ...
  menu: function() {
    ...
    menu.append(new MenuItem({ label : 'nimbus v' + pjson.version, enabled : false }));
  ...
  logout: function() {
    window.location.href = 'nimbus://logout'
  },
