...
mb.on('ready', function() {
  ...
  function doLogin() {
    ...
    loginWindow.loadURL('https://soundcloud.com/connect?client_id=f17c1d67b83c86194fad2b1948061c9e&response_type=token&scope=non-expiring&display=next&redirect_uri=nimbus://oauth/callback')
  }
  ...
  /**
   * register nimbus protocol
   */
  var protocol = electron.protocol
  protocol.registerHttpProtocol('nimbus', function(req) {
